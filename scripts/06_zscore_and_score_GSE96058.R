# =============================================================================
# SCRIPT: 06_zscore_and_score_GSE96058.R
# PURPOSE: Applies Core-PAM score to GSE96058 cohort:
#          Intra-cohort Z-score, rescaled score (Effective Gene Count),
#          standardized direction (HR>1), generates analysis_ready.parquet
# COHORT:  GSE96058 (external validation RNA-seq)
# PROJETO: Core-PAM (Memorial v6.1 / Freeze Core-PAM)
# =============================================================================

source("scripts/00_setup.R")
SCRIPT_NAME <- "06_zscore_and_score_GSE96058.R"
COHORT      <- "GSE96058"
