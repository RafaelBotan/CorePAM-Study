# =============================================================================
# SCRIPT: 20_prepare_pCR_GSE20194.R
# PURPOSE: Harmonize clinical (pCR), preprocess expression (Affymetrix
#          HGU133Plus2), compute CorePAM score for GSE20194.
#          Produces analysis_ready.parquet for 21_pCR_logistic_analysis.R.
#
# COHORT:  GSE20194 | Endpoint: pCR (pathologic complete response to NACT)
# PLATFORM: HGU133Plus2 (GPL570)
# N expected: ~278 pre-treatment biopsies
# REF: Park S et al. + NCNN; paclitaxel/FAC NACT regimen
#
...
SCRIPT_NAME <- "20_prepare_pCR_GSE20194.R"
COHORT      <- "GSE20194"
GEO_ACC     <- "GSE20194"
...
# --------------------------------------------------------------------------
# 4) Load CorePAM weights + intra-cohort Z-score + score
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# 5) Assemble final data frame and save
# --------------------------------------------------------------------------
