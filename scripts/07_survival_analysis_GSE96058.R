# =============================================================================
# SCRIPT: 07_survival_analysis_GSE96058.R
# PURPOSE: Analise de sobrevida CorePAM na coorte GSE96058:
#          Cox univariado + CORE-A, C-index bootstrap, KM (mediana + quartis).
#          Segue Memorial v6.1 §8.
# COORTE:  GSE96058 | Endpoint primario: OS
# PROJETO: Core-PAM (Memorial v6.1 / Freeze Core-PAM)
# =============================================================================

source("scripts/00_setup.R")
SCRIPT_NAME <- "07_survival_analysis_GSE96058.R"
COHORT      <- "GSE96058"
ENDPOINT    <- "OS"
...
# --------------------------------------------------------------------------
# 5) KM: mediana intra-coorte + quartis
# --------------------------------------------------------------------------
