# =============================================================================
# SCRIPT: 06_zscore_and_score_TCGA_BRCA.R
# PURPOSE: Applies Core-PAM score to TCGA-BRCA cohort:
...
SCRIPT_NAME <- "06_zscore_and_score_TCGA_BRCA.R"
COHORT      <- "TCGA_BRCA"
...
# TCGA: expression IDs = patient_id in clinical
score_df <- tibble(
...
clin_score <- inner_join(clin_df, score_df, by = "patient_id")
...
# --------------------------------------------------------------------------
# 7) Determine score direction (TCGA primary endpoint = OS)
# --------------------------------------------------------------------------
