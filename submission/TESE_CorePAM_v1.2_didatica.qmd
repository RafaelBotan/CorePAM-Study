...
Na @fig-km-tcga, a separação é mais discreta. Isso é esperado, não contraditório. A TCGA-BRCA tem seguimento mediano curto, menor número de eventos e composição clínica menos voltada a seguimento longitudinal de câncer de mama do que coortes desenhadas para prognóstico. Mesmo assim, a direção do efeito permanece correta e estatisticamente significativa na análise contínua, sustentando a transportabilidade dentro de *RNA-seq*.

Clinicamente, a @fig-km-tcga lembra uma consulta com pouco tempo de seguimento: a ausência de grande diferença visual não significa ausência de biologia, mas menor oportunidade de observar eventos. A contribuição da TCGA-BRCA é mostrar que o escore calculado em outro *pipeline* de *RNA-seq* mantém a mesma direção, ainda que com menor amplitude.
...
Na @fig-forest-survival, cada linha é uma coorte externa e cada quadrado é a estimativa de efeito do CorePAM naquela coorte. A linha vertical em HR = 1 representa ausência de associação; tudo à direita favorece maior risco com maior escore. O leitor deve notar que todos os quadrados estão à direita de 1, ainda que com tamanhos e intervalos diferentes. O diamante final resume a evidência conjunta e também fica claramente à direita de 1. Em oncologia, essa leitura é parecida com comparar subgrupos de um ensaio: nem todos têm o mesmo peso, mas a consistência de direção importa. O I-quadrado de 38,2% indica que existe variação real entre coortes, mas não a ponto de destruir a mensagem principal.
...
|:----------------|:----------|--:|:--------------------|:------------------:|:---------------|
| SCAN-B OS | Todos | 2649 | 1,75 (1,51-2,03) | 0,770 / 0,787 | +0,017; 4,9 x 10^-13^ |
| SCAN-B OS | RE+ | 2450 | 1,68 (1,43-1,97) | 0,770 / 0,784 | +0,014; 1,1 x 10^-10^ |
| METABRIC DSS | Todos | 1792 | 1,25 (1,14-1,38) | 0,678 / 0,693 | +0,015; 6,1 x 10^-6^ |
| METABRIC DSS | RE+ | 1377 | 1,47 (1,31-1,65) | 0,674 / 0,707 | +0,032; 1,0 x 10^-10^ |
...
Os 24 genes do CorePAM não são um conjunto arbitrário; demonstram coerência biológica notável, representando todos os quatro eixos funcionais reconhecidos do PAM50 e da biologia intrínseca do câncer de mama [@perou2000; @sorlie2001; @pratperou2011; @harbeck2019]:
...
- **Proliferação celular:** MYBL2, PTTG1, EXO1, MYC, CENPF, UBE2C, BIRC5, TYMS, CDC20, MKI67. Este cluster captura, em nível transcricional, o que Ki67 tenta representar isoladamente na IHQ. Estes genes estão relacionados à progressão do ciclo celular (MYBL2, CDC20), reparo de DNA e segregação cromossômica (EXO1, CENPF, BIRC5, UBE2C), metabolismo de nucleotídeos (TYMS) e sinalização *downstream* de oncogenes (MYC). A alta expressão conjunta deste módulo define tumores biologicamente agressivos, independentemente do subtipo. Na prática clínica, é este módulo que o Ki67 tenta capturar — imperfeita e inconsistentemente, por problemas conhecidos de variação inter-observador [@cheang2009].
...
# APÊNDICE A — Artigo aceito no *Breast Cancer Research* {.unnumbered}

| **Local para artigo aceito publicado em revista** |
|:--|
| Inserir aqui o PDF da versão final publicada assim que a versão de registro estiver disponível no site da revista. |
| `[ PLACEHOLDER VISUAL: PDF FINAL DO ARTIGO ]` |

O manuscrito completo "CorePAM: a 24-gene PAM50-derived expression *score* with *cross-platform* external validation for breast cancer prognosis" [@botan2026] foi aceito para publicação no periódico *Breast Cancer Research* (Springer Nature) em 27 de abril de 2026, referente ao Submission ID `c2980ad5-9b3d-41a2-bf47-f093c5dc8c5f`.

O periódico *Breast Cancer Research* é uma revista internacional, revisada por pares, de acesso aberto, dedicada a estudos biológicos, translacionais e clínicos em câncer de mama. O escopo oficial inclui patogênese molecular e celular, genômica e tecnologias de alto desempenho, patologia, intervenções clínicas, imagem, rastreamento, prevenção e epidemiologia. A página oficial da Springer Nature informa fator de impacto 2024 de **5,6**, fator de impacto de cinco anos de **7,0**, indexação em bases como MEDLINE/PubMed, Scopus, SCIE e PubMed Central, e classifica a revista como título específico de câncer de mama no primeiro quartil global de oncologia. Em listas públicas de referência Qualis/CAPES consultáveis por ISSN, *Breast Cancer Research* online (ISSN 1465-542X) aparece como **Qualis A1** em áreas biomédicas; como o Qualis varia por área e quadriênio, a versão final da tese deve manter a área/consulta usada pela secretaria do programa.

O DOI atribuído pela Springer Nature é `10.1186/s13058-026-02298-5`. Em conferência realizada em 17 de maio de 2026, o DOI ainda não resolvia publicamente em `doi.org` e a consulta à API Crossref retornava 404; portanto, a versão de registro com volume, número do artigo e PDF final ainda parecia pendente de produção editorial. O acordo de publicação foi concluído em 14 de maio de 2026, e o pedido de *waiver* integral da APC foi aprovado em 14 de maio de 2026. Quando a página final estiver ativa, este apêndice deve substituir o placeholder pelo PDF publicado e atualizar volume, número de artigo, data de publicação e link permanente.
