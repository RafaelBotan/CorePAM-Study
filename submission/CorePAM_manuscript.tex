...
\textbf{Subgroup analysis:} ER-stratified analyses were performed in SCAN-B (ER status available in 94\% of samples). Cox HR and C-index were computed separately for ER-positive and ER-negative subgroups, with an interaction test (score $\times$ ER status).
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/Fig1_StudyDesign_EN.png}
...
\small
\begin{tabular*}{\textwidth}{@{\extracolsep\fill}lcrrrll}
\toprule
Cohort & Endpoint & N & Events & FU (mo) & Univariate HR (95\% CI) & C-index (95\% CI) \\
\midrule
SCAN-B\footnotemark[1] & OS & 3,069 & 322 & 55.7 & 1.92 (1.74--2.13), $p<$0.001 & 0.698 (0.668--0.729) \\
TCGA-BRCA & OS & 1,072 & 150 & 32.0 & 1.20 (1.04--1.40), $p=$0.016 & 0.624 (0.572--0.678) \\
METABRIC & DSS & 1,978 & 646 & 159 & 1.41 (1.31--1.52), $p<$0.001 & 0.638 (0.615--0.659) \\
GSE20685 & OS & 327 & 83 & 112.8 & 1.40 (1.12--1.76), $p=$0.003 & 0.623 (0.562--0.683) \\
GSE1456 & OS & 159 & 40 & 91.1 & 1.71 (1.23--2.38), $p=$0.001 & 0.661 (0.582--0.741) \\
\midrule
 & & & & & \textit{Adjusted HR (95\% CI)\footnotemark[2]} & \\
\midrule
SCAN-B & OS & & & & 1.86 (1.64--2.12), $p<$0.001 & \\
TCGA-BRCA & OS & & & & 1.27 (1.09--1.48), $p=$0.002 & \\
METABRIC & DSS & & & & 1.36 (1.24--1.48), $p<$0.001 & \\
GSE20685 & OS & & & & 1.40 (1.12--1.76), $p=$0.003 & \\
GSE1456\footnotemark[3] & OS & & & & 1.71 (1.23--2.38), $p=$0.001 & \\
\botrule
\end{tabular*}
\footnotetext[1]{Training cohort. C-index shown is in-sample (0.698); OOF C-index = 0.670.}
\footnotetext[2]{Adjusted for CORE-A: age $\pm$ ER status (SCAN-B, METABRIC: age + ER; TCGA-BRCA, GSE20685: age only).}
\footnotetext[3]{CORE-A adjustment not performed (clinical covariates unavailable); univariate HR shown.}
\footnotetext{HR: hazard ratio per 1~SD; FU: median follow-up in censored patients.}
\end{table}
...
\textbf{ER-stratified subgroup analysis.} In SCAN-B (N = 2,870 with ER status), CorePAM was significantly associated with OS in both ER-positive (HR = 1.92; 95\% CI 1.69--2.17; $p < 0.001$; N = 2,646) and ER-negative (HR = 2.53; 95\% CI 1.51--4.25; $p < 0.001$; N = 224) subgroups. The interaction test was not significant ($p$ = 0.25), indicating that the CorePAM prognostic effect does not differ significantly by ER status.
...
\textbf{Calibration and clinical utility.} Calibration at clinically relevant horizons (60 months for SCAN-B, METABRIC, GSE20685; 24 months for TCGA-BRCA) showed adequate concordance between predicted and observed event rates in the training cohort (Figure~\ref{fig:calibration}). Formal logistic recalibration confirmed near-ideal calibration in the training cohort (slope $\beta$ = 0.96) with moderate miscalibration in external cohorts (slopes 1.58--2.74), consistent with model under-confidence when applying scores cross-platform without recalibration---a structural property of intra-cohort z-scoring. Decision curve analysis confirmed positive net benefit across a range of probability thresholds in all cohorts (Additional file~7: Figure~S7).
...
Additional files 1--16 are available as supplementary material. See the Additional files section at the end of this article for descriptions.
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_01_FigS1_Pareto.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_02_FigS2_Weights.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_03_FigS3_Correlation.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_04_FigS4_PCA.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_05_FigS5_METABRIC_Sensitivity.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_06_FigS6_TCGA_24m.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_07_FigS7_DCA_OS.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_08_FigS8_Bootstrap.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_09_FigS9_GeneDropout.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{additional_files/Additional_file_10_FigS10_COREA_Sensitivity.png}
...
\begin{table}[h]
\caption{\textbf{Additional file~14: Table~S4.} Frozen z-score sensitivity analysis. HR and C-index using SCAN-B reference mean/SD (frozen) vs intra-cohort z-score (original).}\label{tab:s4-frozen}
\small
\begin{tabular}{@{}lrcccccc@{}}
\toprule
Cohort & N & Platform & HR frozen & C frozen & HR intra & C intra & $r$ \\
\midrule
SCAN-B & 3,069 & RNA-seq & 8.74 & 0.698 & 8.74 & 0.698 & 1.000 \\
TCGA-BRCA & 1,072 & RNA-seq & 1.68 & 0.624 & 1.88 & 0.624 & 0.999 \\
METABRIC & 1,978 & Microarray & 4.03 & 0.638 & 3.00 & 0.638 & 0.958 \\
GSE20685 & 327 & Microarray & 1.61 & 0.581 & 3.22 & 0.623 & 0.921 \\
\botrule
\end{tabular}
\footnotetext{HR per unit of raw weighted score (no cohort-level re-standardisation). $r$: Pearson correlation between frozen and intra-cohort scores. C-index is rank-invariant.}
\end{table}
