...
\textbf{Additional file~13: Table~S3.} Expanded CORE-A analysis: CorePAM independence from anatomical staging (T-stage, nodal status). (CSV)

\textbf{Additional file~14: Table~S4.} Head-to-head C-index comparison: CorePAM vs research-based ROR-S and OncotypeDX-RS. (CSV)
